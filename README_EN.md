...
[![Download](https://img.shields.io/badge/⬇%20下载%20Download-v1.2.8-3b82f6?style=for-the-badge)](https://github.com/pmh1314520/HypoMuxPlus/releases/download/v1.2.8/HypoMuxPlus.exe)
...
- Direct download: **[HypoMuxPlus.exe (v1.2.8)](https://github.com/pmh1314520/HypoMuxPlus/releases/download/v1.2.8/HypoMuxPlus.exe)** (via GitHub Releases; users in mainland China can use the [Gitee mirror](https://gitee.com/peng-minghang/hypo-mux-plus/releases/download/v1.2.8/HypoMuxPlus.exe))
